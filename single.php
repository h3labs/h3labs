  	...
  	<div id="activities-descr">
        ...
        <?php while (have_posts()) : the_post(); ?>
  		...
  		<ul class="inline" style="padding-top:8px;">
  			...
  			<li class="social-btns" style="padding-left:0;"><a href="https://twitter.com/share?url=<?php the_permalink(); ?>" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/twitter_button.png" /></a></li>
  		</ul>
  	</div>
